...
class ThueCanHo extends Component {
    constructor(props) {
        super(props);
        this.state={
            ApartmentHome:[],
        ...
        this.props.StateFiterTyhomeNews_FtoApp(3);
        this.props.ListNewsResettoApp();
    }
    async UNSAFE_componentWillMount(){

        await axios.get('/trang-chu/tin-can-ho')
        .then(res => {
            this.setState({
                ApartmentHome:res.data.ApartmentHome
            })
            if(res.data.ApartmentHome){
                res.data.ApartmentHome.forEach(element => {
        ...
        return (
            <div className="Home container-fluid">
              ...
              { this.props.clickFindNewstoApp  &&
                    ...
                    <div className="row">
                        {
                            this.state.ApartmentHome.map((item,index)=>
                                <div className="col-12 col-sm-6 col-md-4 col-xl-4" key={index} >
                                <div className="Card wow fadeInUp" data-wow-delay="0.3s" >
                                    <div className="cardhome" >
                                        <img className="card-img" src={item.img_avatar} alt="Card"/>
